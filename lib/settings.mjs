...
export const SETTINGS_DEFAULTS = Object.freeze({ mode: "arcade", scanlines: false, muted: false });
 ...
 * `scanlines` does not lose a good `mode` (nor a `muted`). Always returns a
 * fresh object.
 */
...
export function serialiseSettings(settings) {
  ...
  return JSON.stringify({ mode, scanlines, muted }, null, 2) + "\n";
}
