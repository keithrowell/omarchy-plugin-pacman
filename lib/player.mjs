 ...
 * wish, which persists until it can be taken. Returns { player, moved } with a
 * new player object; `moved` is the distance travelled in px (snaps excluded).
 */
export function stepPlayer(player, board, wantDir, speedTilesPerS, dt) {
  let x = player.x, y = player.y, dir = player.dir;
  let want = wantDir !== null && wantDir !== undefined && DIRS[wantDir] ? wantDir : player.wantDir;
